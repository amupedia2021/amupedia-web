...
const blogData = [
  {
    ...
    image: "/images/blog/x6sc1eno6shuvql8noth.webp",
    comments: 12,
    likes: 65,
    author:"Ben",
    description:       <>
...
<p class="text-left">
It is the goal of 90%-if not 100%-of geeks who are in tech to get hired, butwithout stepping out to the public that is nearly impossible.
</p> 
<p class="text-left">
...
<p>
My desire to know how the web works has always been my driving force. So
from the day I was given my first mobile phone (Nokia s2) in the year 2010,
I took it upon myself to explore this little gadget at my disposal.
</p>
<p>
...
<p class="text-left mt-2 text-bold">
...
<p class="mb-2 ">
If you are looking to get started with open source, here are some tips to
get started:
</p>
<ul class="list-disc list-inside ">
<li>
...
<a href="https://asana.com/resources/fiedlers-contingency-theory">
  ...
  },
  {
    ...
    image: "/images/blog/AICodeQuality--1-.png",
    comments: 10,
    likes: 7,
    author:"Lisa",
    ...
    <div className="2xl:w-2/3 w-full my-auto">
      ...
      <p className="mb-4">
        ...
        feel like an uphill battle. Or more often than not, a chore not worth
        pursuing. And with the huge advances in AI lately, it would be unfortunate
        not to use what's available to its full advantage.
      </p>
      <p className="mb-4">
        Now what if you could have a digital assistant tirelessly working by your
        side, analyzing every line of code, catching bugs and vulnerabilities
        before they rear their ugly heads, suggesting improvements that elevate
        your work from good to exceptional?
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        quickly find that the results are usually underwhelming.
      </p>
      <p className="mb-4">
        Where AI doesn't let you down is in being your programming assistant. You
        should still be the captain of the ship and steer the direction of your
      ...
      <ol className="list-decimal list-inside pl-4">
        <li className="mb-4">
          ...
          <p className="mb-2">
            ...
            worked on a programming task for hours, only to hit a wall, and then
            have to consult a colleague or Stack Overflow to get new ideas.
          </p>
          <p className="mb-2">
            It's only once I receive this external input from friends or forums
            that I can dig myself out of the mental block and continue with new
            ideas. But this usually takes time (and often someone else's time,
            too), which is precious as a programmer.
          </p>
          <p className="mb-2">
            So I turned to AI to help me out. Even outside of programming, I've
            been a huge advocate that one of the healthy uses of AI is for idea
            generation – and it's not different for programmers.
          </p>
          <p className="mb-2">
            One of the great ways to get over a mental block is to ask ChatGPT for
            suggestions. If you describe your problem in full, it usually does a
            good job and figuring out what the next step could be. Just remember
            to be specific in your prompts, and it helps to include some of your
            code snippets.
          </p>
          <p className="mb-2">
          ...
          <blockquote className="border-l-4 pl-8 italic text-blue-400 mb-2">
            <p>
              ...
              match for the specified class. You need to handle these cases where
              the element is not found to avoid the AttributeError. Additionally,
              you can use the pandas.read_html() function to simplify the process
              of extracting table data from the HTML."
            </p>
          </blockquote>
          <p className="mb-2">
            Personally, I think it's a great suggestion! Certainly would be enough
            to get me back on track.
          </p>
          <p className="mb-2">
            I will emphasize that you should take the ideas more-so then the code
            ChatGPT might suggest wholesale. ChatGPT did suggest code snippets
            from the above question, and in general the code snippets provided
            will work. But it's better to err on the side of caution and be
            accountable for the code you're putting out.
          </p>
        </li>
        <li className="mb-4">
          ...
          <p className="mb-2">
            ...
            footing and don't have a complete grasp of what's right or wrong and
            the best practices to follow.
          </p>
          <p className="mb-2">
            I mainly suggest this for newer programmers, as we already have tools
            such as Application Performance Monitoring Tools (APMs) that can give
            you a good indication of your code quality on larger applications. But
            when you're a newer dev working on smaller projects, AI is a great way
            to get quick and insightful code reviews.
          </p>
          <p className="mb-2">
            If I was able to obtain personalized feedback on my code when I was
            first picking up coding, I'm sure my learning productivity and overall
            code quality would've been much more concrete. I hate to even think
            about what my code looked like in the early days!
          </p>
          <p className="mb-2">
            There are tons of great tools for this. One of my favorites is
            Rankode. They provide personalized reports to you that highlight your
            strengths, areas of improvement, and an overall assessment of your
            programming skills. It's a great way to track your growth as a
            programmer and keep any poor coding habits at bay.
          </p>
        </li>
      </ol>
    </div>
  ...
  {
    id: i++,
    title: "How to Build a Discord AI Chatbot like Your Favorite Character",
    image: "/images/blog/lynns-thumbnail.png",
    comments: 4,
    likes: 10,
    author:"David",
    ...
    <p className="mb-4">
      ...
      5.9k views of my previous tutorial, plus, when I deployed my bot to a 1k+
      user server, people flooded it with 300+ messages in an hour, effectively
    ...
    <ul className="list-disc pl-6 mb-4">
      <li>
        ...
        pre-made datasets on Kaggle or make custom datasets from raw transcripts.
      </li>
      <li>
        Train the model in Google Colab, a cloud-based Jupyter Notebook
        environment with free GPUs.
      </li>
      <li>Deploy the model to Hugging Face, an AI model hosting service.</li>
      <li>Build a Discord bot in either Python or JavaScript, your choice! 🤩</li>
      <li>
    ...
    <pre className="bg-gray-200 p-2 pl-4 mb-4 ">
  ...
  {
    id: i++,
    title: " How to Build and Deploy a Trained AI Model as a Web Service",
    ...
    />
      ...
      <ol className="list-decimal list-inside pl-4">
        <li className="mb-4">
          ...
          <p className="mb-2">
            It is essential that you are familiar with Python machine learning and
            understand how to train machine learning models using Numpy, Pandas,
            SciKit-Learn, and Matplotlib Python libraries.
          </p>
          <p className="mb-2">
            Also, I assume that you are familiar with machine learning theory:
            types of machine learning problems like regression and classification,
            the concept and process of Supervised machine learning (fit/predict
            and evaluate quality using metrics) and common models used for it,
            including Random Forest Classifier, and it's implementation in
          ...
          <p className="mb-2">
            ...
            released about the topics described above. In this article, my goal is
            to show you how to create, train, and deploy a basic machine learning
            model using Julia, without diving into theoretical aspects of ML and
            AI.
          </p>
        </li>
        <li className="mb-4">
          ...
          <p className="mb-2">
            Among others, there are great libraries like Numpy to help you do
            linear algebra with vectors and matrices, Pandas to manipulate
            datasets, Matplotlib for data visualizations, and Scikit-Learn that
            provides a uniform interface to work with well-known machine learning
            models.
          </p>
          <p className="mb-2">
            Also, Jupyter Notebooks allow you to write and run Python code online
            right in a web browser. This creates a comfortable environment for
            data researchers to design and implement the whole machine learning
            cycle even if they are not very experienced in programming.
          </p>
          <p className="mb-2">
            All this is good for research in laboratories, but at some point, you
            need to go to production. At this moment things change dramatically.
          </p>
          <p className="mb-2">
            Python was created in the early nineties and was never supposed to be
            fast. Its kernel was never assumed to be used for new modern
            technologies like distributed computing.
          </p>
          <p className="mb-2">
            That is why, to make complex ML tasks production-ready, you need to
            install a lot of third-party dependencies. You'll also have to employ
            some tricks to speed Python code up. You can even rewrite or convert
            Python machine learning models before deploying them to production in
            faster languages like C++.
          </p>
          <p className="mb-2">
            Well, Julia aimed to resolve these problems. This is what the authors
            wrote about why they created Julia:
          </p>
          <blockquote className="border-l-4 pl-4 italic text-gray-700">
            <p>
              "We are greedy: we want more. We want a language that’s open source,
              with a liberal license. We want the speed of C with the dynamism of
              Ruby. We want a language that’s homoiconic, with true macros like
              Lisp, but with obvious, familiar mathematical notation like Matlab.
              We want something as usable for general programming as Python, as
              easy for statistics as R, as natural for string processing as Perl,
              as powerful for linear algebra as Matlab, as good at gluing programs
              together as the shell. Something that is dirt simple to learn, yet
              keeps the most serious hackers happy. We want it interactive and we
  ...
  {
    id: i++,
    title: " How to work  and choose React Design Patterns",
    image: "/images/blog/aa6g894nyxxmytztd9ta.webp",
    comments: 9,
    likes: 18,
    author:"Jazz",
    description:<>
    ...
    <p>
      Each use cases demand a different pattern to solve the problem in the most
      optimised way and also made our code more scalable.
    </p>
    <p>
    ...
    <p>
      Each component in React has two parts: One is logic to handle your data and
    ...
    <pre style={{backgroundColor:"black",color:"green"}}>
      <code >
        ...
        <span className="hljs-keyword">const</span> DisplayList ={" "}
    ...
    <p>
      Container components, on the other hand, keep track of the internal states
      and data-fetching logic and handles business logic.
    </p>
    <pre style={{backgroundColor:"black",color:"green"}}>
      <code>
        <span className="hljs-keyword">export</span>{" "}
        <span className="hljs-keyword">const</span> PatientComponent ={" "}
        <span className="hljs-function">
        ...
        {"\n"}
        {"  "}
        <span className="hljs-keyword">const</span> [patientList, getPatientList]
        = React.useState([]);{"\n"}
        {"\n"}
        {"  "}React.useEffect( <span className="hljs-keyword">async</span>() =&gt;{" "}
        {"{"}
        {"\n"}
        {"    "}
        ...
        <span className="hljs-keyword">await</span> fetchPatientList();{"\n"}
        {"\n"}
        {"    "}setPatientList([...data]);{"\n"}
        {"  "}
        {"}"}, []);{"\n"}
        ...
        <span className="xml">
          <span className="hljs-tag">
            &lt;<span className="hljs-name">DisplayList</span>{" "}
            <span className="hljs-attr">patientRecord</span>=
            <span className="hljs-string">
              {"{"}patientList{"}"}
            </span>{" "}
            /&gt;
    ...
    <p>Enter fullscreen mode Exit fullscreen mode</p>
    <p>
      The container component passes the state and any required callbacks as props
      to the presentational component. The presentational component is responsible
    ...
    <p>
      HOCs take one component as an input and give a newly created component with
    ...
    <pre style={{backgroundColor:"black",color:"green"}}>
  <code class="bg-gray-900 rounded-lg p-4">
    <span class="text-purple-500">import</span> React{" "}
    <span class="text-purple-500">from</span>{" "}
    <span class="text-green-500">'react'</span>;{"\n"}
    {"\n"}
    <span class="text-purple-500">const</span> withLogger ={" "}
    <span class="text-purple-500">(<span class="text-blue-500">WrappedComponent</span>) =&gt;</span>{" "}
    {"{"}
    {"\n"}
    {"  "}
    <span class="text-purple-500">class</span>{" "}
    <span class="text-yellow-500">WithLogger</span>{" "}
    <span class="text-purple-500">extends</span>{" "}
    <span class="text-yellow-500">React</span>.
    <span class="text-yellow-500">Component</span>{" "}
    {"{"}
    {"\n"}
    {"    "}componentDidMount() {"{"}
    {"\n"}
    {"      "}
    <span class="text-red-500">console</span>.log(
    <span class="text-green-500">`Component {" "}
      <span class="text-yellow-500">${"{"}WrappedComponent.name{"}"}</span>{" "}
      mounted.`</span>
    );{"\n"}
    {"    "}
    {"}"}
    ...
    <span class="text-purple-500">
      &lt;<span class="text-blue-500">WrappedComponent</span> {"{"}
      <span class="text-red-500">...this.props</span>
      {"}"} /&gt;
    </span>
    ;{"\n"}
    {"    "}
    ...
    {"\n"}
    {"  "}
    <span class="text-purple-500">return</span> WithLogger;{"\n"}
    {"}"}
    {"\n"}
    {"\n"}
    <span class="text-green-500">// Usage</span>{"\n"}
    <span class="text-purple-500">const</span> MyComponent = (props) =&gt; {"{"}
    {"\n"}
    {"  "}
    <span class="text-purple-500">return</span>{" "}
    <span class="text-purple-500">
    ...
    {"\n"}
    {"\n"}
    <span class="text-purple-500">const</span> EnhancedComponent = withLogger(MyComponent);
  </code>
</pre>

   
    <p className="mt-4">
      In the example above, <code>withLogger</code> is a HOC that takes a
      component (<code>WrappedComponent</code>) as input and returns a new
      component (<code>WithLogger</code>). The returned component logs a message
      to the console when it mounts and unmounts.
    </p>
    <p className="mt-4">
      To use the HOC, we wrap our original component <code>MyComponent</code> with{" "}
      <code>withLogger</code>, creating a new component{" "}
      <code>EnhancedComponent</code>. The enhanced component has the same
    ...
    <p className="mt-4">
      In this pattern, a component receives a function as a prop and uses that
    ...
    <pre style={{backgroundColor:"black",color:"green"}}>
      <code>
        ...
        <span className="hljs-class">
          ...
          <span className="hljs-title">MouseTracker</span>{" "}
        ...
        {"{"}
        {"\n"}
        {"  "}state = {"{"} <span className="hljs-attr">x</span>:{" "}
        <span className="hljs-number">0</span>,{" "}
        <span className="hljs-attr">y</span>:{" "}
        <span className="hljs-number">0</span> {"}"};{"\n"}
        {"\n"}
        {"  "}handleMouseMove ={" "}
        <span className="hljs-function">
        ...
        <span className="hljs-attr">x</span>: event.clientX,{" "}
        <span className="hljs-attr">y</span>: event.clientY {"}"});{"\n"}
        {"  "}
        {"}"};{"\n"}
        {"\n"}
        {"  "}render() {"{"}
        ...
        <span className="xml">
          <span className="hljs-tag">
            ...
            <span className="hljs-attr">onMouseMove</span>=
            <span className="hljs-string">
        ...
        {"\n"}
        <span className="hljs-keyword">const</span> DisplayMousePosition ={" "}
        <span className="hljs-function">
          <span className="hljs-params">()</span> =&gt;
        </span>{" "}
        ({"\n"}
        ...
        <span className="xml">
          <span className="hljs-tag">
            &lt;<span className="hljs-name">MouseTracker</span>
            {"\n"}
            {"    "}
            <span className="hljs-attr">renderPosition</span>=
            <span className="hljs-string">
              {"{"}({"{"}
            </span>{" "}
            <span className="hljs-attr">x</span>,{" "}
            <span className="hljs-attr">y</span> {"}"}) =&gt;
          </span>{" "}
          ({"\n"}
          {"      "}
    ...
    <p>
      A prop like <code>renderPosition</code> is called a{" "}
      <strong>
        <em>render prop</em>
      </strong>{" "}
    ...
    <p   className="mt-2">
      Compound components are a pattern used in React to create components that
      work together as a group, allowing users to customize and control the
      rendering of multiple related components.
    </p>
    <p>
      It allows you to define a parent component that encapsulates the behaviour
      and state of child components, while still giving flexibility to users to
      determine the composition and appearance of the child components.
    </p>
    <p   className="mt-2">
      Let's consider a use case where you need to create a{" "}
      <strong>List component</strong> in React which looks something like an
      unordered list in native HTML or an Accordion component.
    </p>
    <pre style={{backgroundColor:"black",color:"green"}}>
      <code>
        <span className="hljs-tag">
          &lt;<span className="hljs-name">List</span>&gt;
        </span>
        {"\n"}{" "}
        <span className="hljs-tag">
          &lt;<span className="hljs-name">ListItem</span>&gt;
        </span>
        1
        <span className="hljs-tag">
          &lt;/<span className="hljs-name">ListItem</span>&gt;
    ...
    <p>
      Now in this scenario, we need some of the states of the{" "}
      <strong>List</strong> component to be transferred to its child component
      i.e. <strong>ListItem.</strong> It can be implemented either by using the{" "}
      <code>context API</code> or <code>React.cloneElement</code> API.
    </p>
    <p>
      Let's explore how to develop the same scenario using{" "}
      <strong>Context API</strong>.
    </p>
    <pre style={{backgroundColor:"black",color:"green"}}>
      <code>
        <span className="hljs-keyword">const</span> ListContext =
        React.createContext();{"\n"}
        {"\n"}
        <span className="hljs-comment">// Parent Component</span>
        {"\n"}
        <span className="hljs-keyword">export</span>{" "}
        <span className="hljs-keyword">const</span> List = (props) =&gt; {"{"}
        {"\n"}
        {"  "}
        <span className="hljs-keyword">const</span> {"{"} children,{" "}
        <span className="hljs-built_in">size</span> {"}"} = props;{"\n"}
        {"  "}
        <span className="hljs-keyword">const</span> {"{"} Provider {"}"} =
        ListContext;{"\n"}
        {"\n"}
        {"  "}
        <span className="hljs-keyword">const</span> sharedProp = {"{"}{" "}
        ...
        {"\n"}
        {"\n"}
        <span className="hljs-comment">// Child Component</span>
        {"\n"}
        <span className="hljs-keyword">export</span>{" "}
        <span className="hljs-keyword">const</span> ListItem = (props) =&gt; {"{"}
        {"\n"}
        {"  "}
        <span className="hljs-keyword">const</span> contextProp =
        React.useContext(ListContext);{"\n"}
        {"  "}
        <span className="hljs-keyword">const</span> {"{"}{" "}
        <span className="hljs-built_in">size</span> {"}"} = contextProp;{"\n"}
        {"\n"}
        {"  "}
        <span className="hljs-built_in">return</span> ({"\n"}
        {"   "}&lt;li className={"{"}
        <span className="hljs-built_in">size</span> ==={" "}
        <span className="hljs-string">'medium'</span> ? bg-primary : bg-secondary
        {"}"}&gt;{"\n"}
        {"      "}
        {"{"}props.children{"}"}
        {"\n"}
        ...
        {"\n"}
        <span className="hljs-comment">// Usage</span>
        {"\n"}&lt;List <span className="hljs-built_in">size</span>=
        <span className="hljs-string">'medium'</span>&gt;{"\n"}{" "}
        &lt;ListItem&gt;Item <span className="hljs-number">1</span>
        &lt;/ListItem&gt;{"\n"} &lt;ListItem&gt;Item{" "}
        <span className="hljs-number">2</span>&lt;/ListItem&gt;{"\n"}{" "}
        &lt;ListItem&gt;Item <span className="hljs-number">3</span>
        &lt;/ListItem&gt;{"\n"}&lt;/List&gt;{"\n"}
      </code>
    </pre>
    <p>Enter fullscreen mode Exit fullscreen mode</p>
    <p>
      In the above example, React Context is created to share the prop{" "}
      <code>size</code> between the parent (&lt;<strong>List&gt;</strong>) and
      child (
      <strong>
        <listitem />
      </strong>
    ...
    <p className="mt-2 mb-2">
      Hooks are introduced in React Functional component as a replacement for
      Class components. There are multiple hooks available to manage states and
      different lifecycle methods of React.
    </p>
    <pre style={{backgroundColor:"black",color:"green"}}>
      <code>
        ...
        <span className="hljs-string">'react'</span>;{"\n"}
        {"\n"}
        <span className="hljs-keyword">const</span> Counter ={" "}
        <span className="hljs-function">
          <span className="hljs-params">()</span> =&gt;
        </span>{" "}
        {"{"}
        {"\n"}
        {"  "}
        <span className="hljs-keyword">const</span> [count, setCount] = useState(
        <span className="hljs-number">0</span>);{"\n"}
        {"\n"}
        {"  "}
        <span className="hljs-keyword">return</span> ({"\n"}
    ...
    <p className="mt-4">
      We can also create custom hooks to solve our specific use case and code
      reusability.
    </p>
    <p>
  ...
  <ol className="list-decimal pl-6 tracking-wide">
    ...
    <li>Creating the Serverless Frontend</li>
  ...
  <p className="mb-4">
    Here, we will walk you through the steps of creating an Amazon Aurora
  ...
  <p className="mb-4">
    In this section, we will dive into creating a serverless API using AWS
  ...
  <p className="mb-4">
    Here, we will guide you in building a serverless frontend using JavaScript
  ...
  <p className="mb-4 ">
    In this section, we will introduce Tailwind CSS and demonstrate how to
  ...
  <p className="mb-4">
    Here, we will walk you through the process of deploying your serverless
    application on AWS. We will cover the deployment of Lambda functions, API
  ...
  <p className="mb-4">
    ...
    hands-on experience with AWS services like Lambda, API Gateway, and Aurora
    Serverless. Additionally, you have integrated Tailwind CSS into your
    application for enhanced styling. With the knowledge acquired, you can now
    explore and build more sophisticated serverless applications on AWS.
  </p>
  <p className="mb-4">
